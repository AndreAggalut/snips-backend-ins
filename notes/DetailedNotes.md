...
- [Wednesday](#wednesday)
  ...
  - [Codealong Review](#codealong-review)
  - [Codealong](#codealong)
- [Thursday](#thursday)
  - [Codealong](#codealong-1)

## Tuesday

### Review

- Working in the backend realm of the internet
  - Using a file system in Node.js
    - Just a bunch of files to store data

### Future

- Snips was introduced
  - Just a preview of the front end with some sparse details
...
- API overview
  ...
  - Uses Chrome and OS as a analogy for two "computers" talking to each other
  - Also, talks about Client talking to GitHub.com

- GitHub deep dive API: https://developer.github.com/v3/

  - Can send request to this endpoint to get data.
  - Mess with the api and find out what it gives us
  - Open Postman and make a request to https://api.github.com
    - Meta endpoint to get every route
    - Go to organization endpoint
      - https://api.github.com/orgs/talent-path-la
        - Gives all the details of our organization
    - Go to the repository endpoint
      - https://api.github.com/repos/ScotteRoberts/:repo/branches
        - Gives all branches of Scott's repository
    - Certain routes need some authentication to perform requests
      - You can't just post stuff on someone's account without being that person.

- REST

  - Focused on the data / resources you are trying to send and receive
    - GitHub example
      - Projects
      - Repositories
      - Teams
      - Apps
      - Data
  - Goes through examples of how we can use verbs with the endpoint to perform actions
    - GET /users/:user
    - POST /users/:user
    - PATCH /users/:user
    - DELETE /users/:user

- Jumps into the data model of Snips!

  - Explain the tables and what each datatype means
  - Go over the relationship of the tables

- Dives into the notes on API design

  - `/snippets`
  - Make a table with each of the methods
    - Each endpoint should drill down into the most specific resource
...
Finished chapter 5 and 8 exercies

### Current Event

Read and discussed: [Never Make Assumptions: 5 Golden Rules for Web App Development](https://hackernoon.com/never-make-assumptions-5-golden-rules-for-your-web-app-development-h37l438k9)
